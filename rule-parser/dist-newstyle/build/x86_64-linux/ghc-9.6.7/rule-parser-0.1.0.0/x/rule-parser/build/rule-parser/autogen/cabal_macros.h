...
/* package rule-parser-0.1.0.0 */
#ifndef VERSION_rule_parser
#define VERSION_rule_parser "0.1.0.0"
#endif /* VERSION_rule_parser */
#ifndef MIN_VERSION_rule_parser
#define MIN_VERSION_rule_parser(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_rule_parser */
...
#define CURRENT_COMPONENT_ID "rule-parser-0.1.0.0-inplace-rule-parser"
